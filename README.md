# Local AI Assistant — AWS EC2 user-data Docker
...
user data builds Streamlit as a Docker container managed by systemd.
...
```bash
git clone --branch feature/aws-ec2-userdata-docker \
